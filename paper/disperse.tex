...
\begin{table}[h]
	\caption{Properties with $\text{gas limit} \rightarrow 8000000$}
	\begin{center}
	\begin{tabular}{l r r r}
		function & transfers/block & gas/transfer & transactions \\ \hline
		transfer & 154-216 & 36,947--51,947 & 154--216 \\
		transferFrom & 134--180 & 44,400--59,400 & 134--180 \\
		simple & 206--337 & 23,694--38,739 & 1 \\
		optimized & 242--449 & 17,813--32,928 & 1
	\end{tabular}
	\end{center}
\end{table}
