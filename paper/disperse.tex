...
\title{
	Disperse Protocol\\
	\Large{Optimizing the gas costs of ERC-20 token transfers}
}
...
\bibitem{subtleties} \href{https://github.com/ethereum/wiki/wiki/Subtleties}{Vitalik Buterin. {\em Ethereum Subtleties}, 2018}
